...
%extend Foam::GeometricField< Type, TPatchField, TMesh >
{
    ...
    {
        return Foam::TGeometricBoundaryField< Type, TPatchField, TMesh >( self->boundaryField() );
    }
}
