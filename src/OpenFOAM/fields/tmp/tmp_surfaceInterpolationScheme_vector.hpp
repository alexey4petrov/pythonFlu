...
//---------------------------------------------------------------------------
#ifndef tmp_surfaceInterpolationScheme_vector_cxx
#define tmp_surfaceInterpolationScheme_vector_cxx
...
%inline
{
    namespace Foam
    {
        typedef tmp< surfaceInterpolationScheme< vector > > tmp_surfaceInterpolationScheme_vector;
    }
}
