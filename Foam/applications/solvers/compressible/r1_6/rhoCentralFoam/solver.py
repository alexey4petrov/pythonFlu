...
#---------------------------------------------------------------------------
from Foam.applications.solvers.compressible.r1_6.rhoCentralFoam.BCs import rho
...
def _rhoBoundaryTypes( p ):
    ...
    for patchi in range( rhoBoundaryTypes.size() ):
        if str( rhoBoundaryTypes[patchi] ) == "waveTransmissive":
           ...
           from Foam.applications.solvers.compressible.r1_6.rhoCentralFoam.BCs.rho import fixedRhoFvPatchScalarField
