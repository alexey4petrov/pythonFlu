...
class solidWallHeatFluxTemperatureCoupledFvPatchScalarField( fixedGradientFvPatchScalarField ):
    ...
    def _init__self__DimensionedField_scalar_volMesh( self, *args ):
        ...
        fixedGradientFvPatchScalarField.__init__( self, whftcsf, iF )
        self.coupleManager_ = whftcsf.coupleManager_
        self.KName_ = whftcsf.KName_
    ...
    def type( self ):
        from Foam.OpenFOAM import word
        return word("solidWallHeatFluxTemperatureCoupled")
    ...
    def _clone__DimensionedField_scalar_volMesh( self, *args ) :
        ...
        from Foam.finiteVolume import tmp_fvPatchField_scalar
        obj = solidWallHeatFluxTemperatureCoupledFvPatchScalarField( self, iF )
...
class fvPatchFieldConstructorToTable_solidWallHeatFluxTemperatureCoupled( getfvPatchFieldConstructorToTableBase_scalar() ):
    ...
    def new_patch( self, p, iF ):
        from Foam.finiteVolume import tmp_fvPatchField_scalar
        obj = solidWallHeatFluxTemperatureCoupledFvPatchScalarField( p,iF )
    ...
    def new_patchMapper( self, ptf , p, iF, m ):
        from Foam.finiteVolume import tmp_fvPatchField_scalar
        obj = solidWallHeatFluxTemperatureCoupledFvPatchScalarField( ptf , p, iF, m )
    ...
    def new_dictionary( self, p, iF, dict_ ):
        from Foam.finiteVolume import tmp_fvPatchField_scalar
        obj = solidWallHeatFluxTemperatureCoupledFvPatchScalarField( p, iF, dict_ )
        return tmp_fvPatchField_scalar( obj )
...
#----------------------------------------------------------------------------------------------------------
solidWallHeatFluxTemperatureCoupled_fvPatchFieldConstructorToTable = fvPatchFieldConstructorToTable_solidWallHeatFluxTemperatureCoupled()
