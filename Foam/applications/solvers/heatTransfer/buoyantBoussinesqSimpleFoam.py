...
#--------------------------------------------------------------------------------------
def Ueqn( phi, U, p, turbulence, mesh, g, rhok, eqnResidual, maxResidual ):
...
#--------------------------------------------------------------------------------------
def _TEqn( turbulence, phi, T, rhok, beta, TRef, Pr, Prt, eqnResidual, maxResidual ):
    from Foam.OpenFOAM import word
    from Foam.finiteVolume import volScalarField
...
#--------------------------------------------------------------------------------------    
def pEqn( runTime, mesh, p, phi, U, UEqn, g, rhok, eqnResidual, maxResidual, nNonOrthCorr, cumulativeContErr, pRefCell, pRefValue ): 
...
def main_standalone( argc, argv ):
    ...
    T, p, U, phi, laminarTransport, beta, TRef,Pr, Prt, turbulence, betaghf, pRefCell, pRefValue, rhok = _createFields( runTime, mesh, g )
    ...
    while runTime.loop():
        ...
        UEqn, eqnResidual, maxResidual = Ueqn( phi, U, p, turbulence, mesh, g, rhok, eqnResidual, maxResidual )
        
        TEqn, kappaEff = _TEqn( turbulence, phi, T, rhok, beta, TRef, Pr, Prt, eqnResidual, maxResidual )
        eqnResidual, maxResidual, cumulativeContErr = pEqn( runTime, mesh, p, phi, U, UEqn, g, rhok, eqnResidual, \
