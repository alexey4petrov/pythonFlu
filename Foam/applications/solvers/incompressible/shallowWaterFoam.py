...
if WM_PROJECT_VERSION() == "1.6" :
   if __name__ == "__main__" :
     ...
     pass
      ...
      argv = None
      test_dir= os.path.join( os.environ[ "PYFOAM_TESTING_DIR" ],'cases', 'r1.6', 'incompressible', 'shallowWaterFoam', 'squareBump' )
...
if WM_PROJECT_VERSION() >= "1.7.0" :
   if __name__ == "__main__" :
     ...
     pass
      ...
      argv = None
      test_dir= os.path.join( os.environ[ "PYFOAM_TESTING_DIR" ],'cases', 'r1.7.0', 'incompressible', 'shallowWaterFoam', 'squareBump' )
      argv = [ __file__, "-case", test_dir ]
      os._exit( main_standalone( len( argv ), argv ) )
      pass
