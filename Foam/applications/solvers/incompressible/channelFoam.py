...
if FOAM_REF_VERSION( ">=", "010600" ):
   if __name__ == "__main__" :
     ...
     if len( argv ) >1 and argv[ 1 ]=="-test":
        ...
        pass
     from Foam.applications.solvers.incompressible.r1_6.channelFoam import main_standalone
...
if FOAM_BRANCH_VERSION( "dev", ">=", "010600" ):
   if __name__ == "__main__" :
     ...
     if len( argv ) >1 and argv[ 1 ]=="-test":
        ...
        argv = [ __file__, "-case", test_dir ]  
        pass
     from Foam.applications.solvers.incompressible.r1_6_dev.channelFoam import main_standalone
     os._exit( main_standalone( len( argv ), argv ) )
     pass
   else:
     from Foam.applications.solvers.incompressible.r1_6_dev.channelFoam import main_standalone
