...
//---------------------------------------------------------------------------
#ifndef GeometricFieldHolder_scalar_fvPatchField_volMesh_cpp
#define GeometricFieldHolder_scalar_fvPatchField_volMesh_cpp
...
%ignore  Foam::GeometricFieldHolder< Foam::scalar, Foam::fvPatchField, Foam::volMesh >::operator +=;
%ignore  Foam::GeometricFieldHolder< Foam::scalar, Foam::fvPatchField, Foam::volMesh >::operator -=;
